...
namespace CRMTicketingSystem.Areas.Customer.Controllers
{
    ...
    public partial class PdfViewerController : Controller
    {
        ...
        public IActionResult Preview()
        {
            ...
            //jsonObject.Add("document", "PDF Succinctly.pdf");
            //jsonObject.Add("zoomFactor", "1");
            //jsonObject.Add("isFileName", "true");
            //jsonObject.Add("action", "Load");
            ViewBag.DocumentPath = "PDF Succinctly.pdf";
            //Load(jsonObject);
            //RenderPdfPages(jsonObject);
            //RenderAnnotationComments(jsonObject);
            return View ();
        }
